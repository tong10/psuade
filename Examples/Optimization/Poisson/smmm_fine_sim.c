...
int main(int argc, char **argv)
{
   ...
   /* ---------------*/
   /*printf("FINE MODEL EVALUATION...");*/
   /* ---------------*/

   if (S[0] > 100.00 || S[0] < 0.01 || S[1] > 100.00 || S[1] < 0.01)
   {
      fx[0] = 1000000.00;
      fx[1] = 1000000.00;
      fx[2] = 1000000.00;
...
//printf("%e %e %e %e\n", fx[0], fx[1], fx[2], fx[3]);
   double scale = h * h;
   fx[0] = U[n*(n-1)/4+(n-1)/4] / scale;
   fx[1] = U[n*(n-1)/4+(n-1)/4*3] / scale;
   fx[2] = U[n*(n-1)/4*3+(n-1)/4] / scale;
   fx[3] = U[n*(n-1)/4*3+(n-1)/4*3] / scale;
