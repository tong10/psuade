...
// ************************************************************************
// Definition for the Box-Behnken sampling class
// AUTHOR : CHARLES TONG
// DATE   : 2005
// ************************************************************************
#ifndef __BOXBEHNKENSAMPLINGH__
#define __BOXBEHNKENSAMPLINGH__

#include "Sampling.h"

/**
 * @name Box Behnken sampling method
 *
 **/
...
// class definition
// ************************************************************************
class BoxBehnkenSampling : public Sampling 
{
...
public:
    ...
    */
   BoxBehnkenSampling& operator=(const BoxBehnkenSampling &);
};

#endif // __BOXBEHNKENSAMPLINGH__
