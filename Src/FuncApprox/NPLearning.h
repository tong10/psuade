...
// ************************************************************************
// Definition for the class NPLearning
// AUTHOR : CHARLES TONG
// DATE   : 2013
// ************************************************************************
...
// class definition
// ************************************************************************
class NPLearning : public FuncApprox 
{
   int      depth1_;
   int      depth2_;
   double   epsilon_;
...
private:
   int learn(double *, double *);
   int loadXMatrix(int, int, int, double *, double **);
   int RegressionAnalysis(int, int, double *, double *, double **);
   int evaluate(int, int, double *, double *, double *);
   double meanSquaredError(int, double *, double *);
};
