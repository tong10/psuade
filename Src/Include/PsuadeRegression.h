...
// DATE   : 2014
// ************************************************************************
#ifndef __PSUADEREGRESSIONH__
#define __PSUADEREGRESSIONH__
...
// class definition
// ************************************************************************
class PsuadeRegression : public FuncApprox 
{
public:
   psVector VecCoeffs_;

   PsuadeRegression(int, int);
   ~PsuadeRegression();
   ...
   double optFunction(psVector, psVector, psVector);

private:
   int    userFunction(int, double *, int, double *);
};

#endif // __PSUADEREGRESSIONH__
