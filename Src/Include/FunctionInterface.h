...
public:
   ...
   /** This function reads experimental data file for optimization */
   double readDataFile(int nInputs, int nOutputs, psMatrix &, 
                       psMatrix &, psMatrix &, int);
   ...
   /** This function has a number of test problems and solution methods */
