...
//**/ *********************************************************************
//**/ for storing information in the INPUT section
//**/ ---------------------------------------------------------------------
...
public:
   ...
   psStrings StrFixedInpNames_;
   psVector  VecFixedInpVals_;
   psVector  VecInpLBds_;
   psVector  VecInpUBds_;
   psIVector VecInpPDFs_;
   psVector  VecInpMeans_;
   psVector  VecInpStdvs_;
   psVector  VecInpAuxs_;
   psIVector VecInpSyms_;
   psIVector VecInpNumVals_;
   psMatrix  MatInpVals_;
   psVector  VecSamInps_;
   psMatrix  corMatrix_;
   psIVector VecInpSInds_;
   int  useInputPDFs_;
   psStrings StrSamFileNames_;
...
//**/ *********************************************************************
//**/ for storing information in the OUTPUT section
//**/ ---------------------------------------------------------------------
...
//**/ *********************************************************************
//**/ for storing information in the METHOD section
//**/ ---------------------------------------------------------------------
...
//**/ *********************************************************************
//**/ for storing information in the APPLICATION section
//**/ ---------------------------------------------------------------------
...
//**/ *********************************************************************
//**/ for storing information in the ANALYSIS section
//**/ ---------------------------------------------------------------------
typedef struct 
{
   double FilterLBound_;
   double FilterUBound_;
   char   FilterDataFile_[2000];  /* psuade data file name as RS filter  */
   char   FilterIndexFile_[2000]; /* index file that gives input indices */
} psuadeFilter;
...
public:
   ...
   void updateFixedParameters(int nfixed, char **names, double *vals);
   ...
   // Update information about the analysis section
