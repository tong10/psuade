...
c
   ...
   13 continue                                                            755
    ...
    7 m=0                                                                 817
      ...
      kr=0                                                                821
      nopt=0                                                              822
      if(it.gt.0) write(it,98) m,txm,0.0,1.0                              823
   ...
   58 if(it .le. 0) go to 59                                             1085
      ...
      if(m.eq.mtot+1) write(it,100) m,gcv,fkr,tcst,fjn,hol,tb(4,m)       1092
      if(m.eq.mtot+2) write(it,99) m,mp,gcv,fkr,tcst,fjn,hol,tb(4,m)     1093
   59 mtot=m                                                             1094
      m=m+1                                                              1095
   ...
   66 tcst=nopt*df1+kr+1.0                                               1121
      ...
      if(m.eq.mtot+1) write(it,100) m,gcv,fkr,tcst,tx(2),hol,tx(4)       1129
      if(m.eq.mtot+2) write(it,99) m,mp,gcv,fkr,tcst,tx(2),hol,tx(4)     1130
      go to 68                                                           1131
   67 xk=xm(jp)+xs(jp)*tx(3)                                             1132
      if(m.eq.mtot+1) write(it,93) m,gcv,fkr,tcst,tx(2),xk,tx(4)         1133
      if(m.eq.mtot+2) write(it,94) m,mp,gcv,fkr,tcst,tx(2),xk,tx(4)      1134
   68 mtot=m                                                             1135
      go to 8                                                            1136
  ...
  100 format('   ',i3,'    ',g12.4,2('   ',f5.1),'       ',f3.0,a28,f3.0 1270
    ...
    7 lq=lq+1                                                            1310
      ...
      write(6, '('' increase parameter maxdph in subroutine addpar to '' 1312
     1)')                                                                1313
      write(6,'('' '',i10,''  or larger, and recompile mars.'')') lq     1314
      stop                                                               1315
    8 que(1,lq)=big                                                      1316
      que(2,lq)=0.0                                                      1317
      n(lq)=ib                                                           1318
   ...
   13 na=m-1                                                             1559
      ...
      write(it,25) m,s,u,lp(3,m),efm,(lv(i),i=k2,i2)                     1568
      return                                                             1569
   ...
   22 call lsf(nk,np,nkp1,0.d0,d,d(1,lm),s,u,d(1,nkp3),1)                1601
      ...
      write(it,25) m,s,u,lp(3,m),efm,(lv(i),i=k2,i2)                     1605
   23 continue                                                           1606
      return                                                             1607
   ...
   26 format(/' estimated optimal model = response mean.')               1611
    ...
    6 na=m-1                                                             1649
      ...
      write(it,13) m,u,lp(3,m),efm,(lv(i),i=k2,i2)                       1656
      return                                                             1657
    7 ip=nk+4                                                            1658
      do 11 m=1,na                                                       1659
      k2=lp(2,m)                                                         1660
   ...
   10 continue                                                           1676
      ...
      write(it,13) m,u,lp(3,m),efm,(lv(i),i=k2,i2)                       1681
   11 continue                                                           1682
      return                                                             1683
   ...
   14 format(/' estimated optimal model = response mean.')               1687
    ...
    3 continue                                                           1761
      ...
      if(it.gt.0) write(it,34) ni,u                                      1765
      return                                                             1766
    4 nkp1=nk+1                                                          1767
      nkp2=nk+2                                                          1768
      nkp3=nk+3                                                          1769
   ...
   32 continue                                                           1895
      ll=ll+1                                                            1896
      go to 28                                                           1897
   33 if(it.gt.0) write(it,34) lt,u                                      1898
      return                                                             1899
   ...
   18 format(/,' relative variable importance:')                         2259
    ...
    1 if(i2.ge.n) go to 2                                                2264
      ...
      write(it,'(/,'' '',6(''    '',i4,''    ''))') (i,i=i1,i2)          2268
      write(it,'('' '',6g12.4)') (a(i),i=i1,i2)                          2269
      go to 1                                                            2270
    2 return                                                             2271
      end                                                                2272
   ...
   32 continue                                                           2766
    ...
    3 write(it,'(/,'' bsfn:'',6(''    '',i4,''    ''))') (i,i=i1,i2)     2874
      write(it,'('' coef:'',6g12.4)') (a(i),i=1,l2)                      2875
      go to 1                                                            2876
    4 return                                                             2877
      end                                                                2878
   ...
   25 continue                                                           3635
    ...
    1 continue                                                           3648
      ...
      wm(1)=wm(1)/wt                                                     3650
      wm(2)=wm(2)/wt                                                     3651
      write(it,'(/,'' binary (0/1) response:  mass(0) ='',g12.4,         3652
     1                           ''   mass(1) ='',g12.4)') wm(1),wm(2)   3653
      return                                                             3654
    2 write(it,'(/,'' ordinal response:'')')                             3655
      write(it,'(''      min         n/4         n/2        3n/4         3656
     1 max'')')                                                          3657
      do 3 i=1,n                                                         3658
      m(i)=i                                                             3659
    3 continue                                                           3660
      call psort(y,m,1,n)                                                3661
      write(it,'('' '',5g12.4)') y(m(1)),y(m(n/4)),y(m(n/2)),y(m(n-n/4)) 3662
     1,y(m(n))                                                           3663
      return                                                             3664
      end                                                                3665
    ...
    1 continue                                                           3673
      ...
      write(it,'(/,'' there are'',i3,'' ordinal predictor variables.'',/ 3675
     1)') no                                                             3676
      write(it,'(''  var     min         n/4         n/2        3n/4     3677
     1     max'')')                                                      3678
      n1=n/4                                                             3679
      n2=n/2                                                             3680
      n3=n-n1                                                            3681
      ...
      write(it,'('' '',i3,'' '',5g12.4)') j,  x(m(1,j),j),x(m(n1,j),j),x 3684
    ...
    2 continue                                                           3686
      ...
      n2=2*p+1                                                           3695
      np=0                                                               3696
      write(it,'(/,'' there are'',i3,'' categorical predictor variables. 3697
     1'')') nct                                                          3698
      i=2                                                                3699
      go to 2                                                            3700
    1 i=i+(2)                                                            3701
    ...
    3 continue                                                           3710
      ...
      mm(ic)=mm(ic)+1                                                    3713
    4 continue                                                           3714
      write(it,'(/,'' categorical variable'',i3,'' has'',i3,'' values.'' 3715
     1)') np,nv                                                          3716
      write(it,'(''  value     internal code     counts'')')             3717
      k=0                                                                3718
      do 5 j=j1,j2                                                       3719
      k=k+1                                                              3720
      write(it,'(f6.0,i13,i15)') cm(j),k,mm(k)                           3721
    5 continue                                                           3722
      go to 1                                                            3723
    6 return                                                             3724
      end                                                                3725
    ...
    2 na=m-1                                                             3756
      ...
      k2=lp(2,m)                                                         3758
      i2=lp(1,m)+k2-1                                                    3759
      write(it,5) m,lp(3,m),(lv(i),i=k2,i2)                              3760
    3 continue                                                           3761
      return                                                             3762
   ...
   17 format (' bug in match - term not found.')                         3903
      do 19 j=1,nv                                                       3904
      write(6,18)j,te(1,j),te(2,j)                                       3905
   18 format (' te(',i2,')=',2g12.4)                                     3906
   19 continue                                                           3907
      do 21 j=1,nk                                                       3908
      write(6,20)j,(tb(i,j),i=1,4)                                       3909
   ...
   13 return                                                             4122
    ...
    4 continue                                                           4279
     ...
     1nk,4)                                                              4293
      ...
      if(it.gt.0) write(it,'(/,'' sample reuse to estimate df:'')')      4296
      if(ix .le. 0) go to 1                                              4297
      nr=ix                                                              4298
      nd=nr                                                              4299
      if(it.gt.0) write(it,'('' '',i3,'' - fold cross-validation.'',/)') 4300
     1 ix                                                                4301
      go to 2                                                            4302
    1 nr=1                                                               4303
      nd=-ix                                                             4304
      if(it.gt.0) write(it,'('' independent test set - every'',i4,'' obs 4305
     1ervations.'',/)') nd                                               4306
    2 do 3 i=1,n                                                         4307
      wt(i,1)=w(i)                                                       4308
      wt(i,2)=i                                                          4309
   ...
   18 gcv=cv(m,2)/(1.0-((dfu*fc+1.0)*m+1.0)/wn)**2                       4388
      if(it.gt.0) write(it,22) m,dfu,cv(m,2),gcv,cv(m,3)                 4389
      go to 16                                                           4390
   ...
   20 dfs=df                                                             4395
      ...
      if(it.gt.0) write(it,22) 0,dmx,yv,gcv,cv0                          4397
      if(it.gt.0) write(it,'(/,'' estimated optimal df('',i3,'') ='',f7. 4398
     12,               '' with (estimated) pse ='',g12.4)') im,df,cvm    4399
      return                                                             4400
   ...
   10 continue                                                           4443
    ...
    4 il=il+1                                                            4465
      ...
      write(6,  '('' increase parameter mlist in subroutine nest to grea 4467
    ...
    5 m(1,il)=i                                                          4470
      ...
      write(6,  '('' increase parameter nlist in subroutine nest to grea 4475
   ...
   16 return                                                             4499
      ...
      write(it,'(/,'' variable nesting:'',/)')                           4503
      do 18 k=1,il                                                       4504
      if(m(3,k) .le. 5) go to 17                                         4505
      write(it,'('' '',i3,'': var('',i3,'') exists for var('',i3,'') ='' 4506
     1)')  k,m(1,k),m(2,k)                                               4507
      write(it,'(100('' '',10f7.1))') (vm(l),l=m(4,k)+1,m(4,k)+m(3,k))   4508
      go to 18                                                           4509
   17 write(it,'('' '',i3,'': var('',i3,'') exists for var('',i3,'') ='' 4510
     1,5f7.1)')  k,m(1,k),m(2,k),(vm(l),l=m(4,k)+1,m(4,k)+m(3,k))        4511
   18 continue                                                           4512
      return                                                             4513
   ...
   20 if((l).gt.(il)) go to 24                                           4519
      ...
      jv=m(3,l)                                                          4522
      jp=m(4,l)                                                          4523
      if(j1.lt.1.or.j1.gt.p) write(it,25) l,j1                           4524
      if(jn.lt.1.or.jn.gt.p) write(it,26) l,jn                           4525
      if(lx(jn).ge.0) write(it,27) l,jn,lx(jn)                           4526
      k1=cm(2*jn)+.1                                                     4527
      k2=cm(2*jn+1)+.1                                                   4528
      ...
      go to 22                                                           4534
   21 continue                                                           4535
   22 if(ig.eq.0) write(it,28) l,vm(k),jn                                4536
   23 continue                                                           4537
      go to 19                                                           4538
   24 return                                                             4539
   ...
   18 return                                                             4787
    ...
    7 continue                                                           4846
      ...
      write(6,'('' increase parameter nlist in subroutine mkmiss to '',i 4855
     15,                      '' and recompile.'')') p                   4856
      stop                                                               4857
    1 do 3 j=1,p                                                         4858
      m(j)=0                                                             4859
      do 2 i=1,n                                                         4860
