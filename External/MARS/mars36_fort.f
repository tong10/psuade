...
c     end                                                                  77
    ...
    4 il=il+1                                                              96
      ...
      write(9,  '('' increase parameter mlist in subroutine setint to gr   98
   ...
   13 return                                                              120
      ...
      write(9,'(/,'' interactions prohibited between:'')')               124
      do 14 l=1,il                                                        125
      write(9,'(''    var('',i3,'')  and  var('',i3,'')'')') m(1,l),m(2  126
     1,l)                                                                 127
   14 continue                                                            128
      return                                                              129
  ...
  100 format('   ',i3,'    ',g12.4,2('   ',f6.1),'       ',f5.0,a28,f5.0 1270
   ...
   26 format(/' estimated optimal model = response mean.')               1611
    ...
    6 na=m-1                                                             1649
      ...
      write(9 ,13) m,u,lp(3,m),efm,(lv(i),i=k2,i2)                       1656
      return                                                             1657
    7 ip=nk+4                                                            1658
      do 11 m=1,na                                                       1659
      k2=lp(2,m)                                                         1660
   ...
   10 continue                                                           1676
      ...
      write(9 ,13) m,u,lp(3,m),efm,(lv(i),i=k2,i2)                       1681
   11 continue                                                           1682
      return                                                             1683
...
c     end                                                                3143
   ...
   25 continue                                                           3635
    ...
    2 continue                                                           3686
      ...
      n2=2*p+1                                                           3695
      np=0                                                               3696
      write(9 ,'(/,'' there are'',i3,'' categorical predictor variables. 3697
     1'')') nct                                                          3698
      i=2                                                                3699
      go to 2                                                            3700
    1 i=i+(2)                                                            3701
    ...
    3 continue                                                           3710
      ...
      mm(ic)=mm(ic)+1                                                    3713
    4 continue                                                           3714
      write(9 ,'(/,'' categorical variable'',i3,'' has'',i3,'' values.'' 3715
     1)') np,nv                                                          3716
      write(9 ,'(''  value     internal code     counts'')')             3717
      k=0                                                                3718
      do 5 j=j1,j2                                                       3719
      k=k+1                                                              3720
      write(9 ,'(f6.0,i13,i15)') cm(j),k,mm(k)                           3721
    5 continue                                                           3722
      go to 1                                                            3723
    6 return                                                             3724
      end                                                                3725
    ...
    2 na=m-1                                                             3756
      ...
      k2=lp(2,m)                                                         3758
      i2=lp(1,m)+k2-1                                                    3759
      write(9 ,5) m,lp(3,m),(lv(i),i=k2,i2)                              3760
    3 continue                                                           3761
      return                                                             3762
...
c     end                                                                3835
   ...
   17 format (' bug in match - term not found.')                         3903
      do 19 j=1,nv                                                       3904
      write(9,18)j,te(1,j),te(2,j)                                       3905
   18 format (' te(',i2,')=',2g12.4)                                     3906
   19 continue                                                           3907
      do 21 j=1,nk                                                       3908
      write(9,20)j,(tb(i,j),i=1,4)                                       3909
...
c     end                                                                4123
    ...
    4 continue                                                           4279
     ...
     1nk,4)                                                              4293
      ...
      nr=ix                                                              4298
      nd=nr                                                              4299
      if(it.gt.0) write(9 ,'('' '',i3,'' - fold cross-validation.'',/)') 4300
     1 ix                                                                4301
      go to 2                                                            4302
    1 nr=1                                                               4303
      nd=-ix                                                             4304
      if(it.gt.0) write(9 ,'('' independent test set - every'',i4,'' obs 4305
     1ervations.'',/)') nd                                               4306
    2 do 3 i=1,n                                                         4307
      wt(i,1)=w(i)                                                       4308
      wt(i,2)=i                                                          4309
   ...
   18 gcv=cv(m,2)/(1.0-((dfu*fc+1.0)*m+1.0)/wn)**2                       4388
      if(it.gt.0) write(9 ,22) m,dfu,cv(m,2),gcv,cv(m,3)                 4389
      go to 16                                                           4390
   ...
   20 dfs=df                                                             4395
      ...
      if(it.gt.0) write(9 ,22) 0,dmx,yv,gcv,cv0                          4397
      if(it.gt.0) write(9 ,'(/,'' estimated optimal df('',i3,'') ='',f7. 4398
...
c     entry nstlst(it)                                                   4500
      ...
      write(9 ,'('' '',i3,'': var('',i3,'') exists for var('',i3,'') ='' 4506
     1)')  k,m(1,k),m(2,k)                                               4507
      write(9 ,'(100('' '',10f7.1))') (vm(l),l=m(4,k)+1,m(4,k)+m(3,k))   4508
      go to 18                                                           4509
   17 write(9 ,'('' '',i3,'': var('',i3,'') exists for var('',i3,'') ='' 4510
   ...
   20 if((l).gt.(il)) go to 24                                           4519
      ...
      jv=m(3,l)                                                          4522
      jp=m(4,l)                                                          4523
      if(j1.lt.1.or.j1.gt.p) write(9 ,25) l,j1                           4524
      if(jn.lt.1.or.jn.gt.p) write(9 ,26) l,jn                           4525
      if(lx(jn).ge.0) write(9 ,27) l,jn,lx(jn)                           4526
      k1=cm(2*jn)+.1                                                     4527
      k2=cm(2*jn+1)+.1                                                   4528
      ...
      go to 22                                                           4534
   21 continue                                                           4535
   22 if(ig.eq.0) write(9 ,28) l,vm(k),jn                                4536
   23 continue                                                           4537
      go to 19                                                           4538
   24 return                                                             4539
...
c     call nest(n,j,pn,1,1.0)                                            4837
    ...
    7 continue                                                           4846
      ...
      write(9,'('' increase parameter nlist in subroutine mkmiss to '',i 4855
